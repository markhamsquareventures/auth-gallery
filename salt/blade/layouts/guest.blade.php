...
<body class="font-instrument-sans text-neutral-900 antialiased">
    <div
        class="min-h-screen flex flex-col justify-between sm:justify-normal items-center pt-4 sm:p-4 bg-white dark:bg-neutral-900">
        <div class="justify-self-start">
            <a href="/">
                <x-salt.application-logo />
            </a>
        </div>
